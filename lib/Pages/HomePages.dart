...
import 'package:farming_app/Pages/FilterList/ExpenseFilter.dart';
      ...
      appBar: AppBar(
        ...
        title: StreamBuilder(
            ...
            builder: (context, snapshot) {
              ...
              return new Text(userDocument["farmName"]);
            }
        ),
      ),
      drawer: MyDrawer(),
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return GestureDetector(
                          onTap: ()  async{
                            ...
                            print ("NEW__________TOKEN_________${Variables.depositAmount}");
                            print ("NEW__________TOKEN_________${Variables.collectionNameID}");
                            setState(() {
