...
class _MyHomePageState extends State<FormPage> {
  ...
  Map<String, dynamic> _categories = {
    ...
    "responseBody": [
      {
        "category_id": "1",
        "category_name": "${Language.bank_loan}",
        "amount": "0.00"
      },
      {
        "category_id": "2",
        "category_name": "${Language.ongshidar_biniyog}",
        "amount": "0.00"
      },
      {
        "category_id": "3",
        "category_name": "${Language.nogod_dhar}",
        "amount": "0.00"
      },
      {
        "category_id": "4",
        "category_name": "${Language.mach_bikri}",
        "amount": "0.00"
      },
      {
        "category_id": "5",
        "category_name": "${Language.onnanno}",
        "amount": "0.00"
      },
  ...
  createData() {
    if (memberName == null || selectCat == null) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
              'Your $selectCat details and Amount is $memberAmount added to the List'),
          duration: Duration(seconds: 2),
        ),
      );
    }
  ...
  deleteData() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content:
            Text('Your $selectCat details and Amount is $memberAmount deleted'),
        duration: Duration(seconds: 2),
      ),
    );
    print("created");
