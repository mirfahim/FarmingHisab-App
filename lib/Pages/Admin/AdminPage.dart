...
import 'package:farming_app/Pages/Admin/CreateUser.dart';
...
class _AdminPageState extends State<AdminPage> {
        ...
        children: [
          ...
          GestureDetector(
            onTap: (){
              ...
              Route route = MaterialPageRoute(builder: (c) => CreateUser());
               Navigator.pushReplacement(context, route);
            },
            child: Container(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            await FirebaseFirestore.instance.collection('KaziFarm').doc("newFarm").collection("newfarm").where('name', isEqualTo:
                            memberName).get();
  ...
  updateData() {
    if(memberName == null){
      ...
      FirebaseFirestore.instance.collection("${Variables.collectionNameID}").doc().collection("Password").doc(passID);
